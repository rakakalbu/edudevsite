...
// NEW: find the newest very-recent Opportunity for an Account
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    if (lead && lead.IsConverted) {
      ...
      if (accountId) {
        await conn.sobject('Account').update({ Id: accountId, Phone: phoneE164, PersonMobilePhone: phoneE164, PersonHomePhone: phoneE164 }).catch(()=>{});
      }

      // === NEW guard to avoid duplicate Opps ===
