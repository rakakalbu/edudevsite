  ...
  try {
    ...
    if (masterSchoolId) {
      ...
      await conn.sobject('Account').update({
        Id: accountId,
        Master_School__c: masterSchoolId   // replace whatever was there
      });

      // Clear draft fields on Opportunity
