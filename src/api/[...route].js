...
const ROUTE_MAP = {
  ...
  "register-options-school": "register-options-school.js",
  ...
  "salesforce-query-school": "salesforce-query-school.js",
  ...
  try {
    ...
    if (!routeName) {
      return sendJSON(res, 404, {
        success: false,
        message: "No API route specified",
      });
    }
    ...
    if (!mod) {
      return sendJSON(res, 404, {
        success: false,
        message: `Unknown API route: ${routeName}`,
      });
    }
    ...
    if (!handler) {
      return sendJSON(res, 500, {
        success: false,
        message: `Handler is not a function for route: ${routeName}`,
      });
    }
    ...
    return sendJSON(res, 500, {
      success: false,
      message: err.message || "Router error",
    });
  }
};
